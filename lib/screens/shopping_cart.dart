                  ...
                  TextButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => PaymentScreen(weekday: 'Thursday',),
                        ),
                      );
                    },
                    child: Text(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        SizedBox(width: 20),
                                        Text(cartItems[index].title, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 25),),
                                        Spacer(),
                                        IconButton(
                                              ...
                                              if (state is ShopPageLoadedState) {
                                                ...
                                                BlocProvider.of<ShopBloc>(context)
                                                  ..add(ItemDeleteCartEvent(
                                                      cartItems:
                                                          state.cartData.shopitems, index: index));
                                              } else if (state
                                                ...
                                                BlocProvider.of<ShopBloc>(context)
                                                  ..add(ItemDeleteCartEvent(
                                                      cartItems: state.cartItems, index: index));
                                              } else if (state
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Spacer(),
                                        Text(
                                            '\Rs.${cartItems[index].price * cartItems[index].quantity} ', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20),)
                                      ],
                                    ),
                                  ],
                                ),
                              ...
                              ExpansionTile(
                                ...
                                children: [
                                  ListTile(
                                    ...
                                    trailing: Text("\₹${totalAmount.toStringAsFixed(2)}", textAlign: TextAlign.start, style: TextStyle(fontSize: 14)),
                                  ),
                                  ListTile(
                                    title: Text(
                                      "Coupon Discount",
